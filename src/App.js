        ...
        const HELP_TABS = [
          ...
          },
          {
            ...
            steps: [
              ...
              { text: 'To fix one by hand: click the "Open" link in the Map column → right-click the correct rooftop in Google Maps → copy lat/lng → click the pin chip on the row → paste → save. It jumps to Fixed instantly. After a re-upload, new parcels appear in Pending and your saved coords are preserved.' },
