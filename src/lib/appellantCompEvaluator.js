...
//
// Source: N.J.A.C. 18:12-1.1, Categories enumerated (rev. May 19, 2025) —
// NJ Div. of Taxation, Guidelines for Use of 36 Nonusable Categories.
export const NU_CODE_DICTIONARY = {
  ...
  '14': 'doubtful title / quit-claim',
  '15': 'gov buyer / seller',
  '16': 'multi-district sale',
  '17': 'charitable / nonprofit',
  '18': 'deed in lieu / lender',
  '19': 'fire / contamination / damage',
  '20': 'utility easement / RoW',
  '21': 'low/mod income housing',
  '22': 'property exchange / trade',
  '23': 'commercial w/ FF&E or goodwill',
  '24': 'zoning / variance change',
  '25': 'nominal consideration ($100 or less)',
  '26': "not arm's-length (other)",
  '27': 'pre-revaluation sale',
  '28': 'sale-leaseback',
  '29': 'post-appeal / Freeze Act',
  '30': 'multi-parcel package',
  '31': '1st sale after foreclosure',
  '32': 'record card mismatch',
  '33': 'farmland / exempt / abated',
  '34': 'class vs. actual use',
  '35': 'partial rights / reservation',
  '36': 'outlier ratio (state use)'
};
